              ...
              <>
                ...
                <div className="px-1 py-4">
                  ...
                  <div className="relative mt-1 h-3">
                    <span className="absolute left-0 font-mono text-[12px] text-t4">0</span>
                    {[
                      { v: 10, label: "10%" },
                      { v: 50, label: "50%" },
                      { v: 90, label: "90%" },
                      ...
                      <span
                        key={ref.label}
                        className="absolute font-mono text-[12px] text-t4 -translate-x-1/2"
                        style={{ left: `${ref.v}%` }}
                      >
                        {ref.label}
                      </span>
                    ))}
                    <span className="absolute right-0 font-mono text-[12px] text-t4">c</span>
                  </div>
                  <p className="font-mono text-[12px] text-center text-t4 mt-1">
                    {calculationResult.peakVelocityFraction >= 1
