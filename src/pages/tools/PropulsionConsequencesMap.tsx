        ...
        <div className="space-y-6">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                >
                  {PROPULSION_TYPES.map((type) => (
                    <div key={type.value} className="flex items-start gap-3 p-3 rounded-none border border-sf-line-interactive hover:border-primary transition-colors">
              ...
              <div className="space-y-3">
                ...
                {computedBenchmarks ? (
                  <>
                    ...
                    <div className="rounded-none border border-sf-line-interactive divide-y divide-border">
                      {BENCHMARK_ROUTES.map((route) => (
              ...
              <div className="space-y-3">
                ...
                {costGuidance && (
                  <div className="p-3 rounded-none bg-muted/50 border border-sf-line-interactive space-y-2 md:col-span-2">
              ...
              <div className="space-y-3">
                ...
                >
                  {COST_COMPARISONS.map((comp) => (
                    <div key={comp.value} className="flex items-start gap-2 p-2 rounded border border-sf-line-interactive">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2">
                  {ACCESS_STRATIFICATIONS.map((option) => (
                    <div key={option.id} className="flex items-start gap-3 p-3 rounded-none border border-sf-line-interactive">
                      <Checkbox
                        id={`access-${option.id}`}
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2">
                  {GOVERNANCE_STRUCTURES.map((structure) => (
                    <div key={structure.id} className="flex items-start gap-3 p-3 rounded-none border border-sf-line-interactive">
                      <Checkbox
                        id={`gov-${structure.id}`}
          ...
          >
            <div className="space-y-6">
              ...
              <div className="p-4 rounded-none bg-accent/10 border border-accent space-y-3">
              ...
              <div className="space-y-3">
                ...
                <div className="grid gap-2">
                  {[
                    ...
                    <div key={check.id} className="flex items-center gap-3 p-2 rounded border border-sf-line-interactive">
                      <Checkbox
                        id={`check-${check.id}`}
                    ...
                    <div className="mt-2 p-4 rounded-none bg-muted/30 space-y-4">
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="border-b border-sf-line-interactive">
                          ...
                          <tbody>
                            {example.data.map((row, i) => (
                              <tr key={i} className="border-b border-sf-line-interactive">
          ...
          >
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Suspense fallback={<div className="min-h-[120px] rounded-md border border-sf-line-interactive bg-background/50 animate-pulse" />}>
                  <RichTextEditor
