...
const SECTIONS: Section[] = [
  ...EVOLUTIONARY_BIOLOGY_SECTIONS.map((s) => ({
    id: `section-${s.id}`,
    title: s.title,
  })),
];
    ...
    >
        ...
        <GlassPanel glow className="p-6 md:p-8 mb-8">
          ...
          <div className="text-sm text-t3 mb-4">
            <strong className="text-t1">The Evolutionary Cascade:</strong>
        ...
        <ToolSidebar>
          ...
          <KeyChoicesSidebar sections={keyChoicesSections} title="Species Summary" mode="inline" />
        </ToolSidebar>
