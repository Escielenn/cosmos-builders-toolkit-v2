    ...
    <div className="w-full h-full flex bg-sf-void/50 rounded-lg p-4 md:p-6 gap-4">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative">
        ...
        <div className="relative">
          {/* Body */}
          <div className="w-16 h-12 md:w-20 md:h-14 bg-gradient-to-br from-sf-cyan/30 to-sf-violet/30 rounded-full border border-sf-cyan/30" />

          {/* Head */}
          <div className="absolute -top-4 left-1/2 -translate-x-1/2 w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-sf-cyan/40 to-sf-violet/40 rounded-full border border-sf-cyan/30" />
          ...
          {/* Pulse effect */}
          <div
            className="absolute inset-0 -m-2 rounded-full border border-sf-cyan/20"
              ...
              <div
                className={`w-3 h-3 rounded-sm border transition-all duration-300 flex items-center justify-center ${
                  completedSections.includes(index)
                    ? "bg-sf-emerald/20 border-sf-emerald/50"
                    : "border-muted/30"
                }`}
              >
                {completedSections.includes(index) && (
