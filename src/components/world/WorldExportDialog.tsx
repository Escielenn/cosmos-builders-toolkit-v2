          ...
          <>
            <Tabs defaultValue="json" className="w-full" onValueChange={(v) => setFormat(v as ExportFormat)}>
              ...
              <TabsContent value="json" className="space-y-4 pt-4">
                <div
                  className="flex items-center space-x-3 p-3 rounded-none border border-sf-line-interactive bg-accent/5"
                >
              ...
              <TabsContent value="notion" className="space-y-4 pt-4">
                {!user ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center space-x-3 p-3 rounded-none border border-sf-line-interactive bg-accent/5">
                      <img
            ...
            {(format === "text" || format === "markdown") && worksheets.length > 1 && (
              <div className="flex items-center space-x-2 pt-2 border-t border-sf-line-interactive">
                <Checkbox
                  id="includeCrossRefs"
