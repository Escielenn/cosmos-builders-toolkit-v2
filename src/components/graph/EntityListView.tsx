  ...
  return (
    <div className="h-full flex" style={{ background: "#0A0E17" }}>
      ...
      >
        {/* Cascade filter */}
        <div>
          <h4 className="text-[9px] font-heading uppercase tracking-[2px] text-tier-4 mb-2">
            Cascade
          </h4>
            ...
            {CONNECTION_STATUSES.map((status) => (
              <button
                ...
                className={cn(
                  ...
                  filters.statuses.has(status) ? "text-tier-2" : "text-tier-5"
                )}
              >
                {status}
              </button>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-1">
        {filteredEntities.length === 0 && (
          <div className="text-center py-12">
            <p className="text-[11px] text-tier-4 font-sans">
          ...
          return (
            <div key={entity.id}>
              ...
              >
                <ChevronRight
                  className={cn(
                    "w-3 h-3 text-tier-4 transition-transform duration-150",
                ...
                />
                <span className="text-[12px] font-heading font-light text-tier-1 flex-1 truncate">
                  {entity.name}
                </span>
                <span className="text-[9px] text-tier-4 uppercase tracking-[1px] font-sans">
                ...
                <div className="ml-7 border-l border-sf-border pl-3 pb-2 space-y-0.5">
                  ...
                  {entityConns.map((conn) => {
                    ...
                    return (
                      ...
                      >
                        <span className="text-[10px] text-tier-4">{arrow}</span>
                        <span className="text-[10px] font-sans text-tier-3">
                        ...
                        <button
                          ...
                          className="text-[10px] font-sans text-tier-2 hover:text-tier-1 transition-colors truncate"
                        >
                          {otherEntity.name}
                        </button>
                        <span
                        ...
                        <button
                          ...
                          className="ml-auto opacity-0 group-hover/conn:opacity-100 text-tier-5 hover:text-crimson transition-all"
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 text-[9px] text-tier-4 hover:text-teal uppercase tracking-[1px] font-sans transition-colors"
                  >
