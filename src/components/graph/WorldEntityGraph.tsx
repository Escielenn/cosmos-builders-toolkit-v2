    ...
    return (
      <div className="h-full w-full flex items-center justify-center" style={{ background: "#0A0E17" }}>
        <div className="text-center max-w-xs">
          ...
          <p className="text-[12px] font-sans text-t3 leading-relaxed mb-4">
      ...
      <div className="relative h-full w-full">
        ...
        >
          <Button
            ...
            variant="ghost"
            onClick={() => setShowCreateEntity(true)}
            className="h-7 text-[12px] uppercase tracking-[1.2px] font-sans text-t3 hover:text-t1"
          >
          ...
          <Button
            size="sm"
            variant="ghost"
            className="h-7 text-[12px] uppercase tracking-[1.2px] font-sans text-t1 bg-white/5"
          >
    ...
    <div ref={graphContainerRef} className="relative h-full w-full" onKeyDown={handleKeyDown} tabIndex={0}>
      ...
      {cascadePathEntityId && (
        ...
        >
          ...
          <span className="text-[12px] font-sans text-teal uppercase tracking-[1px]">
            Cascade Path
          </span>
        ...
        return (
          ...
          >
            <div className="px-3 py-1.5 border-b border-white/[0.06]">
              <span className="text-[12px] font-mono text-t3 uppercase tracking-[1px] truncate block max-w-[180px]">
                {ctxEntity.name}
              </span>
            </div>
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 text-[12px] font-sans text-t2 hover:bg-white/[0.04] hover:text-t1 transition-colors text-left"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 text-[12px] font-sans text-sf-crimson hover:bg-red-500/[0.06] hover:text-red-300 transition-colors text-left"
            >
