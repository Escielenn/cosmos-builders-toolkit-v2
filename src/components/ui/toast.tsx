...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-none p-1 text-t4 opacity-0 transition-opacity duration-base group-hover:opacity-100 hover:text-t1 focus:opacity-100 focus:outline-none",
      className,
    )}
    toast-close=""
    {...props}
