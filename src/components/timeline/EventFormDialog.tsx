            ...
            {isCustomCalendar && selectedCalendar ? (
              ...
              <div className="grid grid-cols-3 gap-2">
                <div>
                  ...
                  />
                  <span className="text-[10px] text-muted-foreground mt-0.5 block">Year (required)</span>
                </div>
                <div>
                  <Input
                    type="number"
                  ...
                  />
                  <span className="text-[10px] text-muted-foreground mt-0.5 block">Month (1-12)</span>
                </div>
                <div>
                  <Input
                    type="number"
                  ...
                  />
                  <span className="text-[10px] text-muted-foreground mt-0.5 block">Day (1-31)</span>
                </div>
              </div>
            )}
          </div>
              ...
              {isCustomCalendar && selectedCalendar ? (
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    />
                    <span className="text-[10px] text-muted-foreground mt-0.5 block">Year</span>
                  </div>
                  <div>
                    <Input
                      type="number"
                    ...
                    />
                    <span className="text-[10px] text-muted-foreground mt-0.5 block">Month</span>
                  </div>
                  <div>
                    <Input
                      type="number"
                    ...
                    />
                    <span className="text-[10px] text-muted-foreground mt-0.5 block">Day</span>
                  </div>
                </div>
              )}
            </div>
