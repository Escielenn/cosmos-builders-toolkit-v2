          ...
          >
            ...
            {compression.style === "break" && (
              <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
                ...
                {compression.label && (
                  <span className="relative text-[9px] text-muted-foreground font-medium px-1 bg-background/60 rounded whitespace-nowrap">
                    {compression.label}
                  </span>
                )}
              </div>
            ...
            {compression.style === "fade" && (
              <div className="w-full h-full relative overflow-hidden">
                ...
                {compression.label && (
                  <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[9px] text-muted-foreground font-medium px-1 bg-background/60 rounded whitespace-nowrap">
                    {compression.label}
                  </span>
                )}
              </div>
            ...
            {compression.style === "spiral" && (
              <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative flex flex-col items-center gap-0.5">
                  ...
                  {compression.label && (
                    <span className="text-[9px] text-muted-foreground font-medium px-1 bg-background/60 rounded whitespace-nowrap">
                      {compression.label}
                    </span>
                  )}
                </div>
