  ...
  return (
    <section className="mt-16 mb-8">
      <div className="flex items-center justify-between mb-8">
        <h2 className="font-display font-light text-2xl uppercase tracking-sf-wide flex items-center gap-3">
          ...
          <Link key={article._id} to={`/learn/${article.slug}`}>
            <GlassPanel className="overflow-hidden h-full hover:bg-accent/50 transition-colors cursor-pointer group">
              ...
              <div className="p-4">
                ...
                <h3 className="font-display font-semibold mt-2 mb-1 line-clamp-2 group-hover:text-primary transition-colors">
                  {article.title}
                </h3>
