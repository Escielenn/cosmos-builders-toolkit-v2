  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      <div className="relative h-8 rounded-md overflow-hidden bg-muted/30 border border-sf-border">
        ...
        {REFERENCE_WORLDS.map((world) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[12px] text-t3 leading-none mt-0.5 whitespace-nowrap">
        ...
        >
          <div className="w-3 h-3 rounded-sm bg-primary border-2 border-background shadow-[0_0_8px_rgba(21,193,123,0.5)]" />
        </div>
      </div>
