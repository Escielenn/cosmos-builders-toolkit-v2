...
| F5 | Atlas view | `13` §4 | ~2 weeks | Cartographer is the map. **Scope +1 (owner, 2026-09-07):** a surface map sheet per entity — upload an equirect/Mercator sheet to a planet or moon and the Atlas renders it at planet zoom. See `13-THE-LIFT.md` §2.1 Atlas |
